...
input_list=("NFYC11_JY_2019_Rep1_")
...
for x in "${input_list[@]}"; do
    ...
    java -Djava.io.tmpdir= ./ -jar ${PICARD_PATH}/picard.jar MarkDuplicates \
...
java -jar ${PICARD_PATH}/picard.jar MarkDuplicates \
        -I mapped/chip/NFYC11_JY_2019_Rep1_.filter.bam \
        -O mapped/chip/NFYC11_JY_2019_Rep1_.dupmark.bam \
        -M mapped/chip/NFYC11_JY_2019_Rep1_.dup.qc \
        -VALIDATION_STRINGENCY LENIENT \
        -REMOVE_DUPLICATES false \
	-ASSUME_SORTED true
 
 
     samtools sort -o mapped/chip/NFYC11_JY_2019_Rep1_.dupmark.sorted.bam \
        mapped/chip/NFYC11_JY_2019_Rep1_.dupmark.bam
        
          samtools index mapped/chip/NFYC11_JY_2019_Rep1_.dupmark.sorted.bam